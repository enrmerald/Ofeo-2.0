API = {
    ...
    "leaks": {
        ...
        "permissions": {"admin": ["list", "add_delete", "show_edit"]},
        "permission_code": {"admin": "admin"},
        "editable": {},
    },
    "users": {
        "fields": [
        ...
        "filters": [],
        "required_fields": ["name", "username", "email", "group", "element_id"],
        "permissions": {
            "admin": ["list", "add_delete", "show_edit"],
            "channel": ["list", "add_delete", "show_edit"],
            "organization": ["list", "add_delete", "show_edit"],
        ...
        "editable": {
            "admin": ["name", "username", "email", "group", "element_id"],
            "person": [],
        },
    },
    "leak_sectors": {
    ...
    "documents": {
        ...
        "required_fields": ["title", "url", "meta_data"],
        "filters": [  # Revisar
            "channel_id",
            "organization_id",
            "person_id",
        ...
        "editable": {"person": ["title", "url", "meta_data"]},
    },
    "numbers": {
        "fields": [
            "id",
        ...
        "editable": {
            "person": ["phone_number", "country_code", "city_code", "last_numbers"]
        },
    },
    "emails": {
        "fields": [
